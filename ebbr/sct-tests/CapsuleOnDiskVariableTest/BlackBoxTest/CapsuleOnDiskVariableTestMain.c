...
Module Name:
  CapsuleOnDiskVariableTestMain.c

Abstract:
  The main source file for Capsule Update "On-Disk" Black-Box Test.
...
EFI_BB_TEST_PROTOCOL_FIELD gBBTestProtocolField = {
  EFI_CAPSULE_ON_DISK_VARIABLE_BB_TEST_REVISION,
  EFI_CAPSULE_ON_DISK_VARIABLE_BB_TEST_GUID,
  L"Capsule On Disk Variable Test",
  L"Capsule On Disk Variable Black-Box Test"
};
...
EFI_BB_TEST_ENTRY_FIELD gBBTestEntryField[] = {
  {
    EFI_CAPSULE_ON_DISK_VARIABLE_TEST_GUID,
    L"CapsuleOnDiskVariableTest_func",
    L"Verifies CapsuleNNNN, CapsuleMax, and CapsuleLast variables are present and valid after a system restart following UpdateCapsule()",
...
EFI_STATUS
EFIAPI
InitializeCapsuleOnDiskVariableBbTest (
...
EFI_STATUS
EFIAPI
UnloadCapsuleOnDiskVariableBbTest (
  IN EFI_HANDLE       ImageHandle
  );
