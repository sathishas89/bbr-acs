...
EFI_BB_TEST_PROTOCOL_FIELD gBBTestProtocolField = {
  ...
  L"Ebbr Profile Table Black-Box Test"
};
...
EFI_BB_TEST_ENTRY_FIELD gBBTestEntryField[] = {
  {
    ...
    L"EbbrProfileTableTest_func",
    L"Test that checks whether EFI Conformance Profile Table supports \
      specific EBBR profile table(2.1 or 2.2) or not",
...
EFI_STATUS
EFIAPI
InitializeEbbrProfileTableBbTest (
