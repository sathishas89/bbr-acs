...
EFI_BB_TEST_PROTOCOL_FIELD gBBTestProtocolField = {
  ...
  L"Secure Boot Authenticated Variable Persistence Test",
  L"Secure Boot Authenticated Variable Persistence Black-Box Test"
};
...
EFI_BB_TEST_ENTRY_FIELD gBBTestEntryField[] = {
  {
    ...
    L"Verify that a Secure Boot test-specific authenticated variable persists across reset.",
