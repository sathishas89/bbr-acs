...
Module Name:
  SbbrEfiFgtFeaturesTestMain.c

Abstract:
  Header file for SBBR EFI FGT features Black-Box Test.
...
EFI_BB_TEST_PROTOCOL_FIELD gBBTestProtocolField = {
  SBBR_EFI_FGT_FEATURES_BB_TEST_REVISION,
  SBBR_EFI_FGT_FEATURES_BB_TEST_GUID,
  L"SBBR EFI FGT features Test",
  L"SBBR EFI FGT features Black-Box Test"
};
...
EFI_BB_TEST_ENTRY_FIELD gBBTestEntryField[] = {
  {
    SBBR_EFI_FGT_FEATURES_TEST_GUID,
    L"SbbrEfiFgtFeaturesTest_func",
    L"Test that EFI checks FGT feature suppport and also handles \
            trap handler for unsupport FGT features",
...
EFI_STATUS
EFIAPI
InitializeSbbrEfiFgtFeaturesBbTest (
...
EFI_STATUS
EFIAPI
UnloadSbbrEfiFgtFeaturesBbTest (
  IN EFI_HANDLE  ImageHandle
  );
